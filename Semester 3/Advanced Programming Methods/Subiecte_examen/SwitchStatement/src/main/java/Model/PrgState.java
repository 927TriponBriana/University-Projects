...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt>stack, MyIDictionary<String, Value> symTable, MyIList<Value>output, MyIDictionary<String,BufferedReader> fileTable, MyIHeap heap, IStmt program){
        this.exeStack = stack;
    ...
    public PrgState(MyIStack<IStmt>stack, MyIDictionary<String, Value>symTable, MyIList<Value>output, MyIDictionary<String, BufferedReader>fileTable, MyIHeap heap){
        this.exeStack = stack;
        this.symTable = symTable;
        this.output = output;
        this.fileTable  = fileTable;
