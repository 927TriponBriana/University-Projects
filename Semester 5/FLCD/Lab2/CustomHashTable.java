...
//    private List<Entry<Value>>[] table;
    ...
    public void addToHashTable(Value value) {
        int index = hashFunction(value);
        List<Value> bucket = table[index];
        bucket.add(value);
    }

//    public void deleteFromHashTable(Value value) {
//        int index = hashFunction(value);
//        List<Value> bucket = table[index];
//        bucket.remove(value);
//    }
    ...
    //    public void addToHashTable(Value value) {
//        int index = hashFunction(value);
//        List<Entry<Value>> bucket = table[index];
//        bucket.add(new Entry<>(value));
//    }

    //    public Value getValueFromHastTable(Key key) {
//        int index = hashFunction(key);
//        List<Entry<Key, Value>> bucket = table[index];
...
//        int index = hashFunction(value);
//        List<Entry<Value>> bucket = table[index];
//        Entry<Value> entryToRemove = null;
//        for(Entry<Value> entry : bucket) {
...
//
//    public boolean isEmpty() {
//        for(List<Entry<Value>> bucket : table) {
//            if(!bucket.isEmpty()) {
//                return false;
//            }
//        }
