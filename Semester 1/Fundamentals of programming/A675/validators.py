...
class StudentValidator(object):
    ...
    def validate(student):
        errors = []
        if student.entity_ID == "": errors.append("Id cannot be empty!")
        if student.name == "": errors.append("Name cannot be empty!")
...
class DisciplineValidator(object):
    ...
    def validate(discipline):
        errors = []
        if discipline.entity_ID == "": errors.append("Id cannot be empty!")
        if discipline.name == "": errors.append("Name cannot be empty!")
