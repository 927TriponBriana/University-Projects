...
from DirectedGraph import DirectedGraph, write_graph_to_file, read_graph_from_file
...
class UI:
    ...
    def find_shortest_path_ui(self):
        ...
        shortest_path = self._graphs[self._current].find_shortest_path(starting_vertex, ending_vertex)
    ...
    def start(self):
        ...
        command_dict = {"1": self.create_random_graph_ui, "2": self.read_graph_from_file_ui,
                        ...
                        "21": self.add_empty_graph, "22": self.parse_all_vertices, "23": self.find_shortest_path_ui}
        while not done:
            try:
                self.print_menu()
